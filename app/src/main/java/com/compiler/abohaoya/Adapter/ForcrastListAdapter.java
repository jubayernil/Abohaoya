 ...
 */
public class ForcrastListAdapter extends ArrayAdapter<WeatherList> {
    Date date;
    private Context context;
    private ArrayList<WeatherList> weatherListsArray;

    public ForcrastListAdapter(Context context, ArrayList<WeatherList> weatherLists) {
...
//        viewHolder.icon.setImageResource(R.drawable.cloud_icon);
        viewHolder.maxTemp.setText("" + String.valueOf((int) Math.ceil(weatherListsArray.get(i).getTemp().getMax())));
        viewHolder.minTemp.setText("" + String.valueOf((int) Math.ceil(weatherListsArray.get(i).getTemp().getMin())));
